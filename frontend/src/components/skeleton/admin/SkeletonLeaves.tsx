export default function SkeletonLeaves() {
  return (
    <div className='p-2 sm:p-6 animate-pulse'>
      ...
      <div className='overflow-x-auto bg-white rounded-xl shadow border p-2 sm:p-4'>
        <div className='hidden sm:block'>
          {/* Header */}
          <div className='grid grid-cols-6 gap-4 bg-gray-50 p-2 rounded mb-4'>
            {[...Array(6)].map((_, i) => (
          ...
          {/* Rows */}
          {[...Array(5)].map((_, i) => (
            <div key={i} className='grid grid-cols-6 gap-4 p-2 border-b'>
